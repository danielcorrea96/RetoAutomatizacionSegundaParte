...
public class PaginaPrincipalLatam extends PageObject {
    ...
    public static final Target SOLO_IDA = Target.the("Solo ida").locatedBy("(//input[@name='flightTypes']//following::label[@data-value=\"showDepartureOnly\"])[1]");
    public static final Target BUSCA_TU_VUELO = Target.the("Busca tu vuelo").locatedBy("//button[contains(text(),'Busca tu vuelo')]");
}
